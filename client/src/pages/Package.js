                    ...
                    <table class="dcf-table dcf-table-responsive dcf-table-bordered dcf-table-striped dcf-w-100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class={packagenamenew === 'package1' ? 'acive' : 'deactive'}><b>Comparison Package</b></th>
                                <th scope="col" class={packagenamenew === 'package2' ? 'acive' : 'deactive'}><b>Comparison Package</b></th>
                                <th scope="col" class={packagenamenew === 'package3' ? 'acive' : 'deactive'}><b>Comparison Package</b></th>
                                <th scope="col" class={packagenamenew === 'package4' ? 'acive' : 'deactive'}><b>Comparison Package</b></th>
                                <th scope="col" class={packagenamenew === 'package5' ? 'acive' : 'deactive'}><b>Comparison Package</b></th>
                                <th scope="col" class={packagenamenew === 'package6' ? 'acive' : 'deactive'}><b>Comparison Package</b></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <th scope="row"></th>
                                <td className="addtd brline">{productline==="1"?"Microsoft 365 for Business":productline==="0"?"Microsoft 365 for Enterprise":"Office 365 for Enterprise"}&nbsp;  &nbsp;  
                                {productplan==="22"?"Premium":productplan==="6"?"Basic":"Standard"} &nbsp; 
                                   {addoption==="0"?"Azure Active Directory Premium P1 (Included)":"Azure Active Directory Premium P2 (Add-on)"} </td>
                                <td className="brline">{packagenamenew ==='Microsoft 365 for Business Standard Azure Active Directory Premium P1 (Add-on)' ? <Link state={{ saasalert: saasalert, packagenamenew: packagenamenew, value: 18.50, dollorspercentage: dollorspercentage, stateData: stateData }} to="/single-package">Microsoft 365 for Business StandardAzure Active Directory Premium P1 (Add-on)</Link> 
                                : <p>Microsoft 365 for Business Standard
                                        Azure Active Directory Premium P1 (Add-on)</p>}</td>
                                <td className="brline">{packagenamenew === 'Microsoft 365 for Business Premium Azure Active Directory Premium P1 (Included)' ? <Link state={{ saasalert: saasalert, packagenamenew: packagenamenew, value: 22, dollorspercentage: dollorspercentage, stateData: stateData }} to="/single-package">Microsoft 365 for Business
                                    Premium
                                ...
                                <td className="brline">{packagenamenew === 'Office 365 for Enterprise E1 Azure Active Directory Premium P1 (Add-on)' ? <Link state={{ saasalert: saasalert, packagenamenew: packagenamenew, value: 16, dollorspercentage: dollorspercentage, stateData: stateData }} to="/single-package">Office 365 for Enterprise
                                    E1
                                    Azure Active Directory Premium P1 (Add-on)</Link> : <p>Office 365 for Enterprise
                                        E1
                                        Azure Active Directory Premium P1 (Add-on)</p>}</td>
                                <td className="brline">{packagenamenew === 'Microsoft 365 for Enterprise E3 Azure Active Directory Premium P1 (Included)' ? <Link state={{ saasalert: saasalert, packagenamenew: packagenamenew, value: 36, dollorspercentage: dollorspercentage, stateData: stateData }} to="/single-package">Microsoft 365 for Enterprise
                                    E3
                                    Azure Active Directory Premium P1 (Included)</Link> : <p>Microsoft 365 for Enterprise
                                        E3
                                        Azure Active Directory Premium P1 (Included)</p>}</td>
                                <td className="brline">{packagenamenew === 'Office 365 for Enterprise E5 Azure Active Directory Premium P1 (Add-on)' ? <Link state={{ saasalert: saasalert, packagenamenew: packagenamenew, value: 44, dollorspercentage: dollorspercentage, stateData: stateData }} to="/single-package">Office 365 for Enterprise
                                    E5
                                    Azure Active Directory Premium P1 (Add-on)</Link> : <p>Office 365 for Enterprise
                                        E5
                                        Azure Active Directory Premium P1 (Add-on)</p>}</td>
                                <td className="brline">{packagenamenew === 'Microsoft 365 for Enterprise E5 Azure Active Directory Premium P2 (Included)' ? <Link state={{ saasalert: saasalert, packagenamenew: packagenamenew, value: 57, dollorspercentage: dollorspercentage, stateData: stateData }} to="/single-package">Microsoft 365 for Enterprise
                                    E5
                            ...
                            <tr>
                                <th scope="row">PRICING
                                    (per person/month)</th>
                                <td className="addtd">{customData?.totalPrice===0?"":customData?.totalPrice && ("$" + customData?.totalPrice)}</td>
                                <td name='$18.50'>{saasalert || addoption === "9" || productline === "1" ? '$18.50' : ''}</td>
                                <td name='$22.00'>{saasalert || addoption === "9" || productline === "1" ? '$22' : ''}</td>
                                <td name='$16.00'>{saasalert || addoption === "9" || productline === "1" ? '$16' : ''}</td>
                                <td name='$36.00'>{saasalert || addoption === "9" || productline === "1" ? '$36' : ''}</td>
                                <td name='$18.50'>{saasalert || addoption === "9" || productline === "1" ? '$44' : ''}</td>
                                <td name='$18.50'>{saasalert || addoption === "9" || productline === "1" ? '$57' : ''}</td>
                            </tr>
                            <tr>
                                <th scope="row">MARGIN $
                                    (per person/month)</th>
                                <td className="addtd">{customData?.totalMarginDollar===0? "":customData?.totalMarginDollar && ("$" + customData?.totalMarginDollar?.toFixed(2))}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ? (18.50 / 100 * (dollorspercentage)).toFixed(2) : ''}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ? (22 / 100 * (dollorspercentage)).toFixed(2) : ''}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ? (16 / 100 * (dollorspercentage)).toFixed(2) : ''}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ? (36 / 100 * (dollorspercentage)).toFixed(2) : ''}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ? (44 / 100 * (dollorspercentage)).toFixed(2) : ''}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ? (57 / 100 * (dollorspercentage)).toFixed(2) : ''}</td>
                            </tr>
                            <tr>
                                <th scope="row">MARGIN %</th>
                                <td className="addtd">{(customData?.totalMarginParcent && (customData?.totalMarginParcent)==="NaN")?"":customData?.totalMarginParcent && (customData?.totalMarginParcent + "%")}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ?dollorspercentage +"%":""}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ?dollorspercentage +"%":""}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ?dollorspercentage +"%":""}</td>
                                <td data-label="Comparison Package">{saasalert || addoption === "9" || productline === "1" ?dollorspercentage +"%":""}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ?dollorspercentage +"%":""}</td>
                                <td>{saasalert || addoption === "9" || productline === "1" ?dollorspercentage +"%":""}</td>
                            </tr>
                            <tr>
